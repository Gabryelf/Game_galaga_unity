    ...
    public class Grid : MonoBehaviour
    {
        ...
        void GenerateGrid()
        {
            ...
            for (int x = 0; x < Width; ++x)
                ...
                {
                    // Увеличиваем расстояние между ячейками на половину по x и y
                    _grid[x, y] = new Vector3(
                        (x - Width * 0.5f + 0.5f) * 0.75f,  // Увеличиваем расстояние по оси x на 50%
                        (y) * 1.5f,  // Увеличиваем расстояние по оси y на 50%
                        0
                    );
                }
        }
